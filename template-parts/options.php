...
echo '
    ...
    <form action="'. esc_url( admin_url( 'admin-post.php' ) ) .'" method="post" id="form-content-generator">
        <div class="input-container" style="margin-bottom: 1rem;">
            <input type="range" id="nbrTokens" name="nbrTokens" min="50" max="8000" value="18" oninput="this.nextElementSibling.value = this.value">
        ...
        if(is_plugin_active('classic-editor/classic-editor.php')) {
                echo '<small style="display: block; margin-top: 1rem;">Vous devez impérativement avoir le focus sur l\'éditeur pour que le texte s\'affiche</small>';
        }
